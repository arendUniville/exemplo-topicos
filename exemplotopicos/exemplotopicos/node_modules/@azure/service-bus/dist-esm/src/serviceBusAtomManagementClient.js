...
export class ServiceBusAdministrationClient extends ServiceClient {
    ...
    listQueuesAll(options = {}) {
        return __asyncGenerator(this, arguments, function* listQueuesAll_1() {
            ...
            let marker;
            try {
                for (var _d = true, _e = __asyncValues(this.listQueuesPage(marker, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const segment = _c;
    ...
    listQueuesRuntimePropertiesAll(options = {}) {
        return __asyncGenerator(this, arguments, function* listQueuesRuntimePropertiesAll_1() {
            ...
            let marker;
            try {
                for (var _d = true, _e = __asyncValues(this.listQueuesRuntimePropertiesPage(marker, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const segment = _c;
    ...
    listTopicsAll(options = {}) {
        return __asyncGenerator(this, arguments, function* listTopicsAll_1() {
            ...
            let marker;
            try {
                for (var _d = true, _e = __asyncValues(this.listTopicsPage(marker, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const segment = _c;
    ...
    listTopicsRuntimePropertiesAll(options = {}) {
        return __asyncGenerator(this, arguments, function* listTopicsRuntimePropertiesAll_1() {
            ...
            let marker;
            try {
                for (var _d = true, _e = __asyncValues(this.listTopicsRuntimePropertiesPage(marker, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const segment = _c;
    ...
    listSubscriptionsAll(topicName, options = {}) {
        return __asyncGenerator(this, arguments, function* listSubscriptionsAll_1() {
            ...
            let marker;
            try {
                for (var _d = true, _e = __asyncValues(this.listSubscriptionsPage(topicName, marker, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const segment = _c;
    ...
    listSubscriptionsRuntimePropertiesAll(topicName, options = {}) {
        return __asyncGenerator(this, arguments, function* listSubscriptionsRuntimePropertiesAll_1() {
            ...
            let marker;
            try {
                for (var _d = true, _e = __asyncValues(this.listSubscriptionsRuntimePropertiesPage(topicName, marker, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const segment = _c;
    ...
    listRulesAll(topicName, subscriptionName, options = {}) {
        return __asyncGenerator(this, arguments, function* listRulesAll_1() {
            ...
            let marker;
            try {
                for (var _d = true, _e = __asyncValues(this.listRulesPage(topicName, subscriptionName, marker, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const segment = _c;
